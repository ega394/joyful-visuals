# SOP 4 — Penugasan Petugas Protokol dan Dokumentasi
...
| **Peringatan** | 1. Penugasan hanya dapat dilakukan atas jadwal berstatus **Disetujui**<br>2. Kewenangan menugaskan dibatasi menurut peran — lihat tabel Kewenangan Penugasan di bawah<br>3. Sistem hanya memberitahu personil yang **berubah** penugasannya; personil yang sudah ditugaskan dan tidak diubah tidak menerima pemberitahuan berulang<br>4. Pencabutan penugasan **wajib diberitahukan** kepada yang bersangkutan<br>5. Jadwal yang belum memiliki personil pada **H-12 jam** akan memunculkan peringatan kepada Kasubbag |
| **Pencatatan dan Pendataan** | 1. Basis data penugasan pada Aplikasi Prokopim Hibot<br>2. Rekapitulasi penugasan bulanan per personil<br>3. Catatan penugasan yang disertakan pada setiap kegiatan |

---

## Kewenangan Penugasan

| Pemberi tugas | Dapat menugaskan |
|---|---|
| Kepala Bagian | Staf Protokol, Admin Rencana Kegiatan, Staf Komunikasi dan Dokumentasi, Ajudan, Kasubbag Protokol, Kasubbag Komdokpim |
| Kasubbag Protokol | Staf Protokol, Admin Rencana Kegiatan, dan sesama Kasubbag Protokol |
| Kasubbag Komdokpim | Staf Komunikasi dan Dokumentasi, dan sesama Kasubbag Komdokpim |
| Staf Komunikasi dan Dokumentasi | Sesama Staf Komunikasi dan Dokumentasi |
| Admin Rencana Kegiatan | Sesama Admin Rencana Kegiatan |
...
1. **Peringatan penugasan kosong.** Bila suatu jadwal berstatus Disetujui belum
   memiliki personil hingga **12 jam sebelum pelaksanaan**, sistem menampilkan
   peringatan kepada Kasubbag Protokol, Kasubbag Komdokpim, dan Staf Komunikasi
   dan Dokumentasi.
2. **Pengingat harian.** Pukul 07.30 WITA seluruh petugas menerima rekap agenda
   harian, dan pukul 15.55 WITA menerima pengingat kegiatan H-1.
3. **Pencabutan penugasan.** Pencabutan dapat dilakukan seluruhnya melalui
   penyuntingan daftar personil, maupun satu per satu melalui aksi cepat pada
   kartu kegiatan. Kedua jalur sama-sama memberitahukan yang bersangkutan.
