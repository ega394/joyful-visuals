# SOP 6 — Pelayanan Peminjaman Ruangan
...
| **Peringatan** | 1. Nomor surat **Srikandi wajib** diisi dengan format nomor/nomor/instansi/tahun<br>2. Pemohon **tidak dapat** mengajukan permohonan baru dalam **10 menit** setelah pengajuan sebelumnya<br>3. Pemohon **paling banyak** memiliki **3 permohonan** yang belum diputuskan pada waktu bersamaan<br>4. Sistem menolak persetujuan atas ruangan dan sesi yang **sudah disetujui** untuk pemohon lain<br>5. Penolakan **wajib disertai alasan**<br>6. Satu permohonan dapat memuat **beberapa tanggal dan sesi** dengan satu kode peminjaman<br>7. Pembatalan oleh pemohon **wajib disertai alasan** dan tetap memerlukan pemrosesan pengelola |
| **Pencatatan dan Pendataan** | 1. Basis data peminjaman ruangan pada Aplikasi Prokopim Hibot<br>2. Kode peminjaman sebagai nomor penelusuran bagi pemohon<br>3. Kalender ketersediaan ruangan<br>4. Arsip surat permohonan yang diunggah |

---

## Sesi Penggunaan Ruangan

| Sesi | Waktu | Berbenturan dengan |
|---|---|---|
| Pagi | 07.30 – 12.00 | Pagi, Full Day |
| Siang | 12.30 – 16.30 | Siang, Full Day |
| Full Day | Seharian | Pagi, Siang, Full Day |
...
## Bagian Prosedur Tambahan — Pembatalan oleh Pemohon
...
1. **Formulir terbuka untuk umum.** Formulir peminjaman dapat diakses tanpa login.
   Pengaman terhadap penyalahgunaan berupa jeda 10 menit antarpengajuan dan batas
   3 permohonan aktif per nomor WhatsApp.
2. **Kerahasiaan data pemohon.** Kalender ketersediaan yang dibuka untuk umum
   hanya menampilkan keterpakaian slot, tanpa identitas maupun nomor kontak
   pemohon. Rincian peminjam hanya dapat dilihat oleh pemegang akun aplikasi.
3. **Satu kode untuk banyak slot.** Satu permohonan yang memuat beberapa tanggal
   memakai satu kode peminjaman, dan diputuskan sekaligus sebagai satu kesatuan.
